...
function StartCTA() {
  return (
    <span className="group relative block size-20 rounded-inherit sm:size-28 sm:text-lg lg:size-32 ring-2 ring-highlight/50 hover:ring-highlight/80">
...
export function Footer() {
  ...
  return (
    <footer className="space-y-4 px-1 pb-32 sm:pb-4">
      <MotionDiv
        initial={{ y: '10%', scale: 0.95, opacity: 0 }}
        whileInView={{ y: '0%', scale: 1, opacity: 1 }}
        transition={{ duration: 0.4 }}
        viewport={{ once: true }}
        className="relative mx-auto flex h-44 flex-col justify-between overflow-hidden rounded-4xl bg-primary-depth/90 text-background dark:bg-card dark:text-card-foreground sm:h-96 lg:h-[26rem]"
      >
        ...
        <div className="max-md:hidden md:flex-grow select-none overflow-hidden">
        ...
        <div className="absolute right-1/4 top-1/2 -translate-y-1/2 md:right-1/3 md:top-[30%] md:translate-y-0">
          {isLoading ? (
